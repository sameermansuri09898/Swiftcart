...
/* ------------------------------------------------------------------ */
/*  PRODUCT CARD — cart-integrated + navigates to product detail page  */
/* ------------------------------------------------------------------ */
export default function ProductCard({ product, badge, showWishlist = true }) {
  ...
  // Navigate to the product detail page (View Product)
...
/* ------------------------------------------------------------------ */
/*  Skeleton — shown while a card's data hasn't loaded yet             */
/* ------------------------------------------------------------------ */
